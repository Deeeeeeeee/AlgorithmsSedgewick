...
public class Point implements Comparable<Point> {
    ...
    private class SlopeOrder implements Comparator<Point> {
        /**
         * compare the slope
         * slope1 is the value of <strong>this point</strong> slopeTo() point1 and
         * slope2 is the value of <strong>this point</strong> slopeTo() point2
         *
         * if and only if slope1 is less than slope2, return negative num;
         * if and only if slope1 equals slope2, return zero;
         * else return positive num
         *
         * @param p1
         * @param p2
         * @return
...
//        StdOut.println(point1.slopeTo(point2) == point1.slopeTo(point3));
        StdOut.println(5.0/3);
        StdOut.println(10.0/6);
    }
}
